/**
 * engineTest.ts — quick regression tests for simulationEngine.ts
 *
 * Run with:
...
import { getScenarioResults, getHourlyReplay } from './simulationEngine'
import type { DesignParams } from './simulationEngine'
...
console.log('\n══════════════════════════════════════════════════════')
console.log('  ThermoShield · simulationEngine.ts — unit tests')
console.log('══════════════════════════════════════════════════════')

/* ── Test 1: Scenario A exact match ──────────────────────────────── */
section('Test 1 — Scenario A (baseline) exact match')
const rA = getScenarioResults(A_PARAMS)
...
const rB = getScenarioResults(B_PARAMS)
...
const rC = getScenarioResults(C_PARAMS)
...
const rMid = getScenarioResults(midParams)
...
const hA = getHourlyReplay(A_PARAMS)
...
const hMid = getHourlyReplay(midParams)
const hC   = getHourlyReplay(C_PARAMS)
