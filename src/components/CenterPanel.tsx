...
import { useVisualizationStore, type CameraViewMode } from '../store/visualizationStore'
import { getLocationProfile } from '../data/locations'
import ShelterScene from './scene/ShelterScene'
import VisualizationModeToggle from './VisualizationModeToggle'
import ClimateProfileCard from './ClimateProfileCard'
...
function compassLabel(deg: number): string {
  ...
  return COMPASS_DIRS[snapped] ?? `${deg}°`
}
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden', minHeight: 0 }}>
        ...
        <div id="viewport-info" style={{
          ...
          {[
            ...
            { k: 'ORIENT', v: `${orientation}° ${compassLabel(orientation)}` },
