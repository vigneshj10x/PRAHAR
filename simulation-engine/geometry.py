...
def calculate_geometry(
    ...
    # 22. Stilt Elevated Tropical Pod
        ...
        floor_area = length * width
        wall_area_total = 2.0 * (length + width) * height + (length * width) * 0.8
        roof_area = 1.15 * length * width
        volume = length * width * height
    ...
    # 23. Subterranean Bermed Bunker
        ...
        north_facing_area = 0.05 * length * height
    ...
    # 24. Modular Hex Cluster (3-cell)
        ...
        wall_area_total = 14.0 * side * height
